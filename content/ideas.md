...
... then you should [get in touch](/about). 

I'd love to be a sounding board or just chat about interesting things adjacent to any of these! 

Inspired by [this page](https://beepb00p.xyz/ideas.html). [Pull requests accepted](https://github.com/jborichevskiy/up-and-to-the-right/pulls).
...
- Google: instead of that stupid note field, __at least__ give us a linked Google Drive document with some metadata pre-inserted
